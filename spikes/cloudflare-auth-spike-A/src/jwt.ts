// ============================================================================
// jwt.ts — ES256 JWT sign + verify + JWKS using Cloudflare Workers Web Crypto.
//
...
//     This is what makes the migration drop-in compatible with most JWKS-aware
//     middleware (Hono jwt helper, panva/jose, etc.).
