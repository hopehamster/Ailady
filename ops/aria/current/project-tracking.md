...
|---|---|---|---|
| **P1 (NOW)** | E1 earned-weight economy (sycophancy fix) → #43 | M9 | First code increment landed 2026-07-07, flag-OFF: optional earned/cheap perception, non-nutritive cheap recognition discharge, I9 properties. Verification: aria-core 109/109, security 35/35, root typecheck 4/4. Baseline staging `aria:talk` still reproduces sycophancy/backpedal + truncated callback. Next: deploy/smoke staging flag-on before any prod flip; current Codex shell lacks CF auth |
