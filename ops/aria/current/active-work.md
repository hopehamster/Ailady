...
2. Continue the next `llmService.ts` shrink slice from the now-extracted `promptShellService.ts` boundary.
3. Extract proactive companion message composition next.
