...
2. Continue the next `llmService.ts` shrink slice from the now-extracted `qualityOrchestrationService.ts` boundary.
3. Extract emotion/shadow/background-update orchestration next.
