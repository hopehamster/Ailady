 ...
 */
export async function getAriaOpinions(_userId: string): Promise<AriaOpinion[]> {
  // PHASE-0 STUB: persistence is Phase-1 memory work.
  // No Firestore read; return the module's documented default opinion set.
...
export async function updateAriaOpinion(
  ...
  // PHASE-0 STUB: persistence is Phase-1 memory work. No-op write.
  return;
}
