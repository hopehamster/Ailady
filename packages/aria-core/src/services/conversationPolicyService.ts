import { getOpenLoopsForPrompt } from './memoryHelpers';
import type {
  IntelligentMemory,
  RelationshipStage,
  ConversationPolicyStrategy,
  ConversationPolicyResponseLength,
  ConversationPolicyQuestionStyle,
  ConversationPolicyMomentumMode,
  ConversationPolicyHookStyle,
  ConversationPolicyClosureStyle,
  ConversationPolicyConsentDepth,
  ConversationPolicyUserEnergy,
  ConversationPolicySessionStage,
  ConversationPolicySignals,
  ConversationPolicySignalSource,
  ConversationPolicyContext,
  ConversationPolicyConversationMessage,
  ConversationPolicyPromptContext,
  ConversationPolicyGuardContext,
  ConversationPolicyPlanSource,
  ConversationPolicyPlan,
  ConversationPolicyConstraints,
...
import type { TempoContext } from './ariaPersonaService';
import {
