...
async function saveImageToFile(base64Data, outputPath) {
    ...
    server.setRequestHandler(ListToolsRequestSchema, async () => {
        return {
            tools: [
                {
                    name: "generate_image",
                    description: "Generate an image using Google Gemini. Optionally provide reference images to guide the generation style or content. Returns a base64-encoded image.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            prompt: {
                            ...
                            model: {
                                type: "string",
                                description: "Gemini model (gemini-3-pro-image-preview, gemini-2.5-flash-preview-05-20, or gemini-2.0-flash-exp)",
                ...
                {
                    name: "edit_image",
                    description: "Edit one or more images using Google Gemini. Provide images and instructions for how to modify them. Returns a base64-encoded image.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            prompt: {
                ...
                {
                    name: "describe_image",
                    description: "Analyze and describe one or more images using Google Gemini. Returns a text description of the image contents.",
                    inputSchema: {
                        type: "object",
                        properties: {
                            images: {
